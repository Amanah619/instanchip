(function () {
  ...
  // =================================================================
  // >>> GANTI LINK GAMBAR DI BAWAH INI UNTUK SEMUA GAME <<<
  // =================================================================
  const LINK_GAMBAR_GAME_GLOBAL = 'https://cdn-icons-png.flaticon.com/128/18164/18164980.png';
  ...
  function renderGameMenu() {
    ...
    GAME_ITEMS.forEach(item => {
      ...
      // DISINI LOGIKA PEMANGGILAN GAMBAR YANG BARU
      // Menggunakan variabel global yang kita buat di atas
      img.src = LINK_GAMBAR_GAME_GLOBAL; 
...
// --- GAME (bottom sheet game) ---
  ...
  const LAINNYA_ITEMS = [
    ...
    // --- Tambahkan menu lain-lain baru di bawah sini ---
  ];
